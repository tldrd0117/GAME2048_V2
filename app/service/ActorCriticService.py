...
class ActorCriticService(object):
    ...
    def run(self):
        ...
        self.treeRepo.addGameInfo(averageTurns, averageScores, averageValues, "ActorCriticService", simulateActions, self.episodeCount)
    ...
    def runEpisode(self):
        ...
        with tf.GradientTape() as tape:
            ...
            while True:
                ...
                action_probs = action_probs.write(gameRepo.turn, action_probs_t[0, action])
                ...
                rewards = rewards.write(gameRepo.turn, 1 if data[1]>0 else 0)
            ...
            # gradient를 구해야함
            loss = self.actorCritic.getGradient(0.99, (action_probs, values, rewards, gameRepo.turn, gameRepo.score), tape)
            grads = tape.gradient(loss, self.actorCritic.model.trainable_variables)
